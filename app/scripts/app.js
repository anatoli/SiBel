  ...
  $translateProvider.translations('ru', {
    ...
    SecondPage:{
      ...
      About:{
        ...
        Text_1_1:'«СиБел» входит в группу компаний «БелХард» и за 10 лет успешной деятельности в сфере системной интеграции достигла признания среди клиентов, вендеров и коллег. Возможность использовать для эффективного решения задач все ресурсы холдинга: производственные, материальные, финансовые и иные — делает сотрудничество успешным. Продвигая собственные ИТ-решения и услуги для белорусских компаний, мы помогаем бизнесу работать.',
        Text_1_2:'Резидентство компании в ПВТ Беларуси подтверждает уровень предоставляемых услуг, внедрение инновационных ИТ-проектов различной сложности. Наши специалисты регулярно проходят обучение, повышают квалификацию и уровень знаний в учебных центрах IBM, Microsoft, Lotus и других, подтверждая результаты успешными сертификационными экзаменами вендоров и производителей.',
        Title_2:'Наша цель',
      ...
      Time:{
        ...
        li_1:'сплоченная работа команды и ответственность за принятие решений приводит к ожидаемому итогу — качественный продуктв заданные сроки',
      ...
      Comments:{
        Title:'Набздоров А.А.',
        Descriptions:'первый заместитель директора по маркетингу и подготовке производства ОАО "Галантея"',
        Text:'Выбор оборудувания и программного обеспечения для автоматизации должен быть обдуманным и взвешенным. Необходимо принимать во внимание не только стоимость, но и доступность послепродажного сервиса, возможность совмещения',
        Btn_1:'Подробнее',
