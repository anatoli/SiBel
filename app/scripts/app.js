  ...
  $translateProvider.translations('ru', {
    ...
    SecondPage:{
      ...
      Comments:{
        ...
        Global_description_1:'Мнение клиентов о сотрудничестве с нами имеет большое значение. Мы дорожим своей репутацией и стремимся поддерживать статус надежного партнера.',
        Global_description_2:' Отзывы о работе с «СиБел» — это объективная оценка нашей деятельности.',
    ...
    $translateProvider.translations('by', {
      ...
      SecondPage:{
        ...
        Comments:{
          ...
          Global_description_1:'Меркаванне кліентаў пра супрацоўніцтва з намі мае вялікае значэнне. Мы даражым сваёй рэпутацыяй і імкнемся падтрымліваць статус надзейнага партнёра.',
          Global_description_2:'Водгукі пра работу з «СіБел» — гэта аб’ектыўная адзнака нашай дзейнасці.',
